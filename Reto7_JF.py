...
import Reto7_JF_epy_block_0 as epy_block_0  # embedded python block
import Reto7_JF_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class Reto7_JF(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Reto7_JF")
        ...
        self._N_0_range = qtgui.Range(0, 1, 0.001, 0, 200)
        ...
        self.qtgui_number_sink_2.set_title('Desv Estandar')
        ...
        self.qtgui_number_sink_0.set_title('Potencia')
        ...
        self.epy_block_1 = epy_block_1.blk(vlen=1024)
        self.epy_block_1.set_block_alias("Estadisticas")
        self.epy_block_0 = epy_block_0.blk(vec_len=1024)
        self.epy_block_0.set_block_alias("Potencia_Promedio")
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_gr_complex*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_complex_to_mag_0 = blocks.complex_to_mag(1)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000, N_0, 0, 0)
        ...
        self.connect((self.blocks_complex_to_mag_0, 0), (self.qtgui_histogram_sink_x_0, 2))
    ...
    def set_N_0(self, N_0):
        self.N_0 = N_0
        self.analog_sig_source_x_0.set_amplitude(self.N_0)




def main(top_block_cls=Reto7_JF, options=None):
